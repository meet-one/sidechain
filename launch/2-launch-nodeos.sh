...
wget https://raw.githubusercontent.com/meet-one/sidechain/master/launch/mainnet/config.ini
wget https://raw.githubusercontent.com/meet-one/sidechain/master/launch/mainnet/genesis.json
cd ~/shell
