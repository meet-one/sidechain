...
wget https://raw.githubusercontent.com/meet-one/sidechain/master/mainnet/config-dir/config.ini
wget https://raw.githubusercontent.com/meet-one/sidechain/master/mainnet/config-dir/genesis.json
cd ~/shell
